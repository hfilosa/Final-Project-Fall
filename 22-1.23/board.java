...
public class board{
	...
	if (getPiece(row,col).equals("N") && !getPieceColor(row,col).equals(color)){
	    return true;
	}
	return false;
    }
	...
	while (startRow!=(endRow-x) || startCol!=(endCol-y)){
	    startRow+=x;
	    startCol+=y;
	...
	System.out.println("The queen can only move diagonally or horizontally");
	return false;
    }
	...
	if (getPiece(row,4).equals("K") && getPieceColor(row,4).equals(color) && getPiece(row,7).equals("R") && getPieceColor(row,7).equals(color)){
	    ...
	    else{System.out.println("Your king or rook have moved earlier in the game. They cannot castle!");}
	}
	...
	if (getPiece(row,4).equals("K") && getPieceColor(row,4).equals(color) && getPiece(row,0).equals("R") && getPieceColor(row,0).equals(color)){
		...
		if (getPiece(row,1).equals(" ") && getPiece(row,2).equals(" ") && getPiece(row,3).equals(" ")){
		    legal = true;
		}
		else {
		    System.out.println( "There are pieces between your king and rook. They cannot castle!");
		}
	    }
	    else{
		System.out.println("Your king or rook have moved earlier in the game and cannot castle");
	    }
	}
	else{System.out.println("Your King or rook isn't even in there original locations! They cannot castle.");}
	if (legal){
